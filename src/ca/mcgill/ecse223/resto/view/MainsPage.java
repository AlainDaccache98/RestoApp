...
public class MainsPage extends JFrame {
  ...
  private void initComponents() {
    ...
    mainsLabel.setText(menuValues.get(1));
    ...
    layout.setHorizontalGroup(layout.createSequentialGroup()
        .addGroup(layout.createParallelGroup().addGap(5).addComponent(mainsLabel).addGap(5).addComponent(backButton, 60,60,100))
        );      
