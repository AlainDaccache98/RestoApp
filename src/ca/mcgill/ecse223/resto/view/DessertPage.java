...
public class DessertPage extends JFrame {
  ...
  private void initComponents() {
    ...
    dessertLabel.setText(menuValues.get(2));
    ...
    layout.setHorizontalGroup(layout.createSequentialGroup()
        .addGroup(layout.createParallelGroup().addGap(5).addComponent(dessertLabel).addGap(5).addComponent(backButton, 60,60,100))
        );      

    layout.setVerticalGroup(layout.createSequentialGroup()
        .addGroup(layout.createParallelGroup().addComponent(dessertLabel).addGap(5))
