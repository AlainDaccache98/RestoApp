...
public class AlcBevPage extends JFrame {
  ...
  private void initComponents() {
    ...
    alcBevLabel.setText(menuValues.get(3));
    ...
    layout.setHorizontalGroup(layout.createSequentialGroup()
        .addGroup(layout.createParallelGroup().addGap(5).addComponent(alcBevLabel).addGap(5).addComponent(backButton, 60,60,100))
        );      

    layout.setVerticalGroup(layout.createSequentialGroup()
        .addGroup(layout.createParallelGroup().addComponent(alcBevLabel).addGap(5))
