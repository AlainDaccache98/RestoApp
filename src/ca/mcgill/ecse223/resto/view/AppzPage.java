...
public class AppzPage extends JFrame {
  ...
  private void initComponents() {
    ...
    appzsLabel.setText(menuValues.get(0));
    ...
    layout.setHorizontalGroup(layout.createSequentialGroup()
        .addGroup(layout.createParallelGroup().addGap(5).addComponent(appzsLabel).addGap(5).addComponent(backButton, 60,60,100))
        );      
